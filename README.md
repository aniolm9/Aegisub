...
```
sudo apt install libx11-dev libgl1-mesa-dev pkg-config libfreetype6-dev libfontconfig1-dev libass-dev libboost-dev libboost-filesystem-dev libboost-chrono-dev libboost-regex-dev libboost-thread-dev libffms2-dev libwxgtk3.0-dev
```
...
```
sudo apt install libx11-dev libgl1-mesa-dev pkg-config libfreetype6-dev libfontconfig1-dev libass-dev libboost-dev libboost-filesystem-dev libboost-chrono-dev libboost-regex-dev libboost-thread-dev libffms2-dev libwxgtk3.0-dev intltool intltool-debian autoconf autogen libtool
```
